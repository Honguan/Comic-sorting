...
class UILanguageTests(unittest.TestCase):
    ...
    def test_catalog_covers_messages_and_preserves_format_fields(self):
        ...
        for name in ("Comic sorting.py", "translation_queue.py", "comic_core.py", "queue_worker.py", "bt_settings.py", "windows_recycle.py", "queue_history.py", "queue_errors.py", "ntfy_notifications.py"):
